    ...
    <body>
        ...
        <div class="container" id="content">
            ...
            ?>
                ...
                <p>India's Best Fashion Store</p>
            ...
            <div class="row text-center" id="cameras">
                <div class="col-md-3 col-sm-6 home-feature">
                        ...
                        <img src="img/m1.jpg" alt="" class="thumbnails">
                        <div class="caption">
                            <h3>Tshirts H&M</h3>
                            <p>Price: Rs. 899.00 </p>
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                        ...
                        <img src="img/m2.jpg" alt="" class="thumbnails">
                        <div class="caption">
                            <h3>EYEBOGLER(Blue, S) </h3>
                            <p>Price: Rs. 609.00 </p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                        ...
                        <img src="img/m3.jpg" alt="" class="thumbnails">
                        <div class="caption">
                            <h3>Sports Tshirt</h3>
                            <p>Price: Rs. 499.00</p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                        ...
                        <img src="img/m4.jpg" alt="" class="thumbnails">
                        <div class="caption">
                            <h3>Cotton Plain</h3>
                            <p>Price: Rs. 700.00</p>
                            <?php if (!isset($_SESSION['email'])) { ?>
            ...
            <div class="row text-center" id="watches">
                <div class="col-md-3 col-sm-6 home-feature">
                        ...
                        <img src="img/m5.jpg" alt="" class="thumbnails">
                        <div class="caption">
                            <h3>Roaster Blue Jeans </h3>
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                        ...
                        <img src="img/m6.jpg" alt="" class="thumbnails">
                        <div class="caption">
                            <h3>Baggy Jeans For Men</h3>
                            <p>Price: Rs. 3000.00 </p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                        ...
                        <img src="img/m7.jpg" alt="" class="thumbnails">
                        <div class="caption">
                            <h3>Men Formal Pant</h3>
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                        ...
                        <img src="img/m8.jpg" alt="" class="thumbnails">
                        <div class="caption">
                            <h3>MACREW Formal Pant</h3>
            ...
            <div class="row text-center" id="shirts">
                <div class="col-md-3 col-sm-6 home-feature">
                        ...
                        <img src="img/m9.jpg" alt="" class="thumbnails">
                        <div class="caption">
                            <h3>Wedding Suit</h3>
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                        ...
                        <img src="img/m10.jpg" alt="" class="thumbnails">
                        <div class="caption">
                            <h3>Men Suits Rose Pink</h3>
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                        ...
                        <img src="img/m11.jpg" alt="" class="thumbnails">
                        <div class="caption">
                            <h3>Mens Sherwani</h3>
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                        ...
                        <img src="img/m12.jpg" alt="" class="thumbnails">
                        <div class="caption">
                            <h3>Manyavar Wedding</h3>
                            <p>Price Rs. 4599.00</p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
